...
if($userlogined){
	if($erduo_in_grade == 1){
		$showstr = '<li class="nav_musicvip"><span class="musicvip_text"><img src="'.get_template(1).'css/svipe.png"><a href="'.rewrite_mode('user.php/profile/credit/').'" target="_blank"><span>'.($erduo_in_vipgrade == 1 ? '月付会员' : '年付会员').'</span></a></span></li>';
