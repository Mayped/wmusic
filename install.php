...
END;
	...
	$sql1="insert into `".tname('plugin')."` (in_name,in_dir,in_file,in_isindex,in_type,in_author,in_address,in_addtime) values ('阿里云存储','oss','uplog','0','3','erduo','http://www.erduo.in/','".date('Y-m-d H:i:s')."')";
