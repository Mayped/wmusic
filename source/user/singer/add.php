...
<title>创建歌手 - <?php echo IN_NAME; ?></title>
...
<form method="get" name="form" onsubmit="addsinger();return false;" class="c_form">
<table cellspacing="0" cellpadding="0" class="formtable"><caption><h2>创建歌手</h2></caption>
<?php if(IN_SHAREOPEN == 0){ ?>
<tr><td style="font-weight:bold;color:red;">抱歉，投稿功能暂未开启！</td></tr>
<?php }else{ ?>
<tr><th style="width:10em;">歌手名称:</th><td><input type="text" id="in_name" class="t_input" size="30" /></td></tr>
<tr><th style="width:10em;">歌手别名:</th><td><input type="text" id="in_nick" class="t_input" size="20" /></td></tr>
...
<tr><th>歌手介绍:</th><td><textarea id="in_intro" cols="40" rows="4" style="width: 282px; height: 118px;"></textarea></td></tr>
