...
<?php global $userlogined,$erduo_in_mail,$erduo_in_ismail; ?>
...
<tr><th style="width:10em;">新邮箱:</th><td><input type="text" id="mail" value="<?php echo $erduo_in_mail; ?>" class="t_input" /><br /><?php if($erduo_in_ismail == 1){echo "[<span style=\"font-weight:bold;\">已激活</span>] 请通过接收邮件验证码来修改邮箱。";}else{echo "[<font color=\"red\">未激活</font>] 请通过接收邮件验证码来激活邮箱。";} ?></td><td><input type="button" value="发送邮件验证码" onclick="editmail(1);" class="submit" /></td></tr>
