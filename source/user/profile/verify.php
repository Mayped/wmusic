...
<tr>[<?php if($erduo_in_isstar == 1){echo "<span style=\"font-weight:bold;color:red;\">已认证</span>";}elseif($erduo_in_isstar == 2){echo "<font color=\"red\">待审核</font>";}else{echo "<span style=\"font-weight:bold;\">未认证</span>";} ?>] 修改认证资料会重新提交审核，本站承诺不会泄漏用户的隐私资料。</tr>
