...
<title>已读消息 - <?php echo IN_NAME; ?></title>
...
<ul class="tabs">
<li class="active"><a href="<?php echo rewrite_mode('user.php/message/index/'); ?>"><span>已读消息</span></a></li>
...
<div class="h_status">
<div class="r_option"><a href="javascript:void(0)" onclick="set_msg(0);">清空所有已读消息</a></div>
<a href="<?php echo rewrite_mode('user.php/message/index/'); ?>"<?php if($message[3] !== 'user' && $message[3] !== 'admin'){echo ' class="active"';} ?>>全部已读</a><span class="pipe">|</span>
<a href="<?php echo rewrite_mode('user.php/message/index/user/'); ?>"<?php if($message[3] == 'user'){echo ' class="active"';} ?>>私人消息</a><span class="pipe">|</span>
<a href="<?php echo rewrite_mode('user.php/message/index/admin/'); ?>"<?php if($message[3] == 'admin'){echo ' class="active"';} ?>>系统消息</a>
</div>
<div class="c_form">
<?php
if($message[3] !== 'user' && $message[3] !== 'admin'){
        $Arr = getuserpage("select * from ".tname('message')." where in_uids=".$erduo_in_userid." and in_isread=1 order by in_addtime desc", 10, 3);
}elseif($message[3] == 'user'){
        $Arr = getuserpage("select * from ".tname('message')." where in_uids=".$erduo_in_userid." and in_isread=1 and in_uid<>0 order by in_addtime desc", 10, 4);
