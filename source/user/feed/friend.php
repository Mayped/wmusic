...
<title>好友在说 - <?php echo IN_NAME; ?></title>
...
<li class="active"><a href="<?php echo rewrite_mode('user.php/feed/friend/'); ?>"><span>好友在说</span></a></li>
...
<div class="doing">
<div class="doingcontent"><a href="<?php echo getlink($row['in_uid']); ?>"><?php echo $row['in_uname']; ?></a>: <span><?php echo $content; ?></span>&nbsp;<span class="gray">(<?php echo datetime($row['in_addtime']); ?>)</span>&nbsp;<a href="javascript:void(0)" onclick="docomment_form(<?php echo $row['in_id']; ?>);">回复</a></div>
...
<option value="<?php echo rewrite_mode('user.php/feed/friend/'); ?>">时间倒序</option>
<option value="<?php echo rewrite_mode('user.php/feed/friend/asc/'); ?>"<?php if($sort == 'asc'){echo " selected";} ?>>时间升序</option>
</select></li></ul>
</div></div>
</div>
<div id="bottom"></div>
