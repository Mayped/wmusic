...
<title>我的访客 - <?php echo IN_NAME; ?></title>
...
<li class="active"><a href="<?php echo rewrite_mode('user.php/friend/visitor/'); ?>"><span>我的访客</span></a></li>
</ul>
</div>
<div id="content" style="width:640px;">
<div class="c_mgs"><div class="ye_r_t"><div class="ye_l_t"><div class="ye_r_b"><div class="ye_l_b">他们拜访过您，回访一下吧</div></div></div></div></div>
<?php
$Arr = getuserpage("select * from ".tname('footprint')." where in_uids=".$erduo_in_userid." order by in_addtime desc", 10, 3);
