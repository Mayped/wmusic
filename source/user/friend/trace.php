...
<title>我的足迹 - <?php echo IN_NAME; ?></title>
...
<li class="active"><a href="<?php echo rewrite_mode('user.php/friend/trace/'); ?>"><span>我的足迹</span></a></li>
<li><a href="<?php echo rewrite_mode('user.php/friend/visitor/'); ?>"><span>我的访客</span></a></li>
</ul>
</div>
<div id="content" style="width:640px;">
<div class="c_mgs"><div class="ye_r_t"><div class="ye_l_t"><div class="ye_r_b"><div class="ye_l_b">您曾经拜访过的用户列表</div></div></div></div></div>
<?php
...
<div class="gray">
<a href="javascript:void(0)" onclick="pop.friend('<?php echo $row['in_unames']; ?>');">添加</a><span class="pipe">|</span>
<a href="javascript:void(0)" onclick="layer.prompt({title:'给“<?php echo $row['in_unames']; ?>”发短消息',type:3},function(msg){sendmessage('<?php echo $row['in_unames']; ?>', msg);});">私信</a>
</div>
</li>
<?php } ?>
</ul></div>
