...
$Arr = getuserpage("select * from ".tname('video')." where in_uid=".$erduo_in_userid." and in_passed=1 and in_classid=".$cid." order by in_addtime desc", 10, 4);
}else{
$get = true;
$Arr = getuserpage("select * from ".tname('video')." where in_uid=".$erduo_in_userid." and in_passed=1 order by in_addtime desc", 10, 3);
}
?>
