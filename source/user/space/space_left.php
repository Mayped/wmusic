...
<li><img src="<?php echo IN_PATH; ?>static/user/images/icon/feed.gif"><a href="<?php echo getlink($ear['in_userid'], 's_feed'); ?>">说说</a><em>(<?php echo $db->num_rows($db->query("select * from ".tname('feed')." where in_type=0 and in_uid=".$ear['in_userid'])); ?>)</em></li>
