...
<title>制作专辑 - <?php echo IN_NAME; ?></title>
...
<table cellspacing="0" cellpadding="0" class="formtable"><caption><h2>制作专辑</h2></caption>
<?php if(IN_SHAREOPEN == 0){ ?>
<tr><td style="font-weight:bold;color:red;">抱歉，投稿功能暂未开启！</td></tr>
<?php }else{ ?>
<tr><th style="width:10em;">专辑名称:</th><td><input type="text" id="in_name" class="t_input" size="30" /></td></tr>
<tr><th style="width:10em;">发行公司:</th><td><input type="text" id="in_firm" class="t_input" size="20" /></td></tr>
...
<tr><th>专辑介绍:</th><td><textarea id="in_intro" cols="40" rows="4" style="width: 282px; height: 118px;"></textarea></td></tr>
