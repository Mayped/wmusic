...
$Arr = getuserpage("select * from ".tname('music')." where in_uid=".$erduo_in_userid." and in_passed=0 and in_classid=".$cid." order by in_addtime desc", 20, 4);
}else{
$get = true;
$Arr = getuserpage("select * from ".tname('music')." where in_uid=".$erduo_in_userid." and in_passed=0 order by in_addtime desc", 20, 3);
}
?>
