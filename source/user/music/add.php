...
<title>上传音乐 - <?php echo IN_NAME; ?></title>
...
<form method="get" name="form" onsubmit="addmusic();return false;" class="c_form">
<table cellspacing="0" cellpadding="0" class="formtable"><caption><h2>上传音乐</h2></caption>
<?php if(IN_SHAREOPEN == 0){ ?>
<tr><td style="font-weight:bold;color:red;">抱歉，投稿功能暂未开启！</td></tr>
<?php }else{ ?>
<tr><th style="width:10em;">音乐名称:</th><td><input type="text" id="in_name" class="t_input" size="30" /></td></tr>
...
<input type="text" id="in_tag" class="t_input" size="30" />
...
<input type="text" id="in_lyric" class="t_input" size="45" />
...
<tr><th>文本歌词:</th><td><textarea id="in_text" cols="40" rows="4" style="width: 282px; height: 118px;"></textarea></td></tr>
