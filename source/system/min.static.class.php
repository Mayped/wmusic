		        ...
		        for($i=0;$i<count($arr[0]);$i++){
			        switch($arr[1][$i]){
				        ...
				        case 'classlink':
                                                ...
                                                break;
				        case 'specialname':
                                                $data = str_replace($arr[0][$i], getlenth(getfield('special', 'in_name', 'in_id', $row['in_specialid'], 'δ֪ר��'), $arr[3][$i]), $data);
                                                break;
				        case 'speciallink':
				        ...
				        case 'specialcover':
                                                ...
                                                break;
				        case 'singername':
                                                $data = str_replace($arr[0][$i], getlenth(getfield('singer', 'in_name', 'in_id', $row['in_singerid'], 'δ֪����'), $arr[3][$i]), $data);
                                                break;
				        case 'singerlink':
