...
if($count==0){
?>
<tr><td colspan="2" class="td27">没有标签</td></tr>
<?php
}
if($result){
...
<td class="td25"><input type="hidden" name="in_id[]" id="in_id" value="<?php echo $row['in_id']; ?>"><input type="checkbox" class="checkbox" name="in_checks<?php echo $row['in_id']; ?>" value="1" checked />保留</td>
</tr>
<?php
}
}
