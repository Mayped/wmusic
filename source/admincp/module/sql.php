...
<body>
<div class="container">
<script type="text/javascript">parent.document.title = 'Ear Music Board 管理中心 - 工具 - 执行语句';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='工具&nbsp;&raquo;&nbsp;执行语句';</script>
...
<li>执行前请先确认语句中的表前缀是否为“<em class="lightnum"><?php echo IN_DBTABLE; ?></em>”</li>
</ul></td></tr>
</table>
<table class="tb tb2">
...
<?php
	...
	if(mysql_query(stripslashes(SafeRequest("in_sql","post",1)))){
		echo "<span style=\"color:#090\">恭喜，语句执行完毕！</span>";
	}else{
		echo "<span style=\"color:#C00\">".mysql_error()."</span>";
	}
}
?>