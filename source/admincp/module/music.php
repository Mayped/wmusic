...
<div class="container">
<script type="text/javascript">parent.document.title = 'Ear Music Board 管理中心 - 内容审核 - <?php echo $arrname; ?>音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;<?php echo $arrname; ?>音乐';</script>
...
<table class="tb tb2">
<tr>
<td class="td29 lightnum">音乐名称：<input type="text" class="txt" value="<?php echo $in_name; ?>" name="in_name" id="in_name">
...
?>
</select>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="pop.up('yes', '选择专辑', 'source/pack/tag/special_opt.php?so=form2.in_specialid', '500px', '400px', '65px');" class="addtr">选择</a></td>
...
<tr>
<td class="td29">音乐标签：<input type="text" class="txt" value="<?php echo $in_tag; ?>" name="in_tag" id="in_tag"><a href="javascript:void(0)" onclick="pop.up('yes', '添加标签', 'source/pack/tag/open.php?form=form2.in_tag', '540px', '400px', '65px');" class="addtr">添加</a></td>
</tr>

<tr>
<td class="longtxt lightnum">音频地址：<input type="text" class="txt" value="<?php echo $in_audio; ?>" name="in_audio" id="in_audio"></td><td><div class="rssbutton"><input type="button" value="上传音频" onclick="pop.up('no', '上传音频', 'source/pack/upload/open.php?type=music_audio&form=form2.in_audio', '406px', '180px', '175px');" /></div>&nbsp;&nbsp;<a href="javascript:void(0)" onclick="pop.record();" class="addtr">录制音频</a></td>
</tr>

<tr>
<td class="longtxt">封面地址：<input type="text" class="txt" value="<?php echo $in_cover; ?>" name="in_cover" id="in_cover"></td><td><div class="rssbutton"><input type="button" value="上传封面" onclick="pop.up('no', '上传封面', 'source/pack/upload/open.php?type=music_cover&form=form2.in_cover', '406px', '180px', '175px');" /></div></td>
</tr>

<tr>
<td class="longtxt">歌词地址：<input type="text" class="txt" value="<?php echo $in_lyric; ?>" name="in_lyric" id="in_lyric"></td><td><div class="rssbutton"><input type="button" value="上传歌词" onclick="pop.up('no', '上传歌词', 'source/pack/upload/open.php?type=music_lyric&form=form2.in_lyric', '406px', '180px', '175px');" /></div></td>
</tr>
</table>

<table class="tb tb2">
<tr><td><div style="height:100px;line-height:100px;float:left;">文本歌词：</div><textarea rows="6" cols="50" id="in_text" name="in_text" style="width:400px;height:100px;"><?php echo $in_text; ?></textarea></td></tr>
<tr><td><input type="submit" class="btn" name="form2" value="提交" onclick="return CheckForm();" /><?php if($_GET['action']=="edit"){ ?><input type="hidden" name="in_addtime" value="<?php echo $Arr[14]; ?>"><input class="checkbox" type="checkbox" name="in_edittime" id="in_edittime" value="1" checked /><label for="in_edittime">更新时间</label><?php } ?></td></tr>
</table>
</form>
</div>
...
<div class="container">
<?php if(empty($action)){echo "<script type=\"text/javascript\">parent.document.title = 'Ear Music Board 管理中心 - 内容审核 - 所有音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;所有音乐';</script>";} ?>
<?php if($action=="pass"){echo "<script type=\"text/javascript\">parent.document.title = 'Ear Music Board 管理中心 - 内容审核 - 待审音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;待审音乐';</script>";} ?>
<?php if($action=="wrong"){echo "<script type=\"text/javascript\">parent.document.title = 'Ear Music Board 管理中心 - 内容审核 - 报错音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;报错音乐';</script>";} ?>
<?php if($action=="keyword"){echo "<script type=\"text/javascript\">parent.document.title = 'Ear Music Board 管理中心 - 内容审核 - 搜索音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;搜索音乐';</script>";} ?>
<?php if($action=="list"){echo "<script type=\"text/javascript\">parent.document.title = 'Ear Music Board 管理中心 - 内容审核 - 栏目音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;栏目音乐';</script>";} ?>
<?php if($action=="special"){echo "<script type=\"text/javascript\">parent.document.title = 'Ear Music Board 管理中心 - 内容审核 - 专辑音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;专辑音乐';</script>";} ?>
<?php if($action=="singer"){echo "<script type=\"text/javascript\">parent.document.title = 'Ear Music Board 管理中心 - 内容审核 - 歌手音乐';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='内容审核&nbsp;&raquo;&nbsp;歌手音乐';</script>";} ?>
<div class="floattop"><div class="itemtitle"><h3><?php if(empty($action)){echo "所有音乐";}else if($action=="pass"){echo "待审音乐";}else if($action=="wrong"){echo "报错音乐";}else if($action=="keyword"){echo "搜索音乐";}else if($action=="list"){echo "栏目音乐";}else if($action=="special"){echo "专辑音乐";}else if($action=="singer"){echo "歌手音乐";} ?></h3><ul class="tab1">
