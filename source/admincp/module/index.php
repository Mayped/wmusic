...
<p>您好, <em><?php echo $_COOKIE['in_adminname']; ?></em> [<a href="?action=logout" target="_top">退出</a>]</p>
...
<li><em><a href="?iframe=music" id="header_content" hidefocus="true" onmouseover="previewheader('content')" onmouseout="previewheader()" onclick="toggleMenu('content', '?iframe=music');doane(event);">内容审核</a></em></li>
...
<li><a href="?iframe=config&action=cache" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>缓存信息</a></li>
...
<li class="s"><div class="lsub desc" subid="M11fe1b9c"><div onclick="lsub('M11fe1b9c', this.parentNode)">音乐</div><ol style="display:" id="M11fe1b9c">
...
<li><a href="?iframe=music" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>所有音乐</a></li>
<li><a href="?iframe=music&action=add" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>新增音乐</a></li>
<li><a href="?iframe=music&action=pass" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>待审音乐</a></li>
<li><a href="?iframe=music&action=wrong" hidefocus="true" target="main"><em onclick="menuNewwin(this)" title="新窗口打开"></em>报错音乐</a></li>
<li class="sp"></li></ol></div></li>
<li class="s"><div class="lsub desc" subid="M34a79c04"><div onclick="lsub('M34a79c04', this.parentNode)">专辑</div><ol style="display:" id="M34a79c04">
...
<li class="sp"></li></ol></div></li>
<li class="s"><div class="lsub desc" subid="M9570187e"><div onclick="lsub('M9570187e', this.parentNode)">视频</div><ol style="display:" id="M9570187e">
...
var cookiepre='3KLp_2132_',cookiedomain='',cookiepath='/';var headers=new Array('index','global','style','content','user','plugin','system','app','uc'),admincpfilename='',menukey='';function switchheader(key){if(!key||!$('header_'+key)){return;}
...
function toggleMenu(key,url){menukey=key;switchheader(key);if(url){parent.main.location=admincpfilename+url;var hrefs=$('menu_'+key).getElementsByTagName('a');for(var j=0;j<hrefs.length;j++){hrefs[j].className=j==(key=='content'?2:0||key=='app'?1:0)?'tabon':'';}}
setMenuScroll();}
...
setMenuScroll();}
var header_key=initCpMenus('leftmenu');toggleMenu(header_key?header_key:'index');function initCpMap(){var ul,hrefs,s='',count=0;for(var k in headers){if(headers[k]!='index'&&headers[k]!='app'&&headers[k]!='uc'&&$('header_'+headers[k])){s+='<tr><td valign="top"><h4>'+$('header_'+headers[k]).innerHTML+'</h4></td><td valign="top">';ul=$('menu_'+headers[k]);if(!ul){continue;}
