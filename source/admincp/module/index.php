...
<table id="frametable" cellpadding="0" cellspacing="0" width="100%" height="100%">
        ...
        <td colspan="2" height="90">
            <div class="mainhd">
                ...
                <div class="uinfo" id="frameuinfo">
                    <p>您好, <em><?php echo $_COOKIE['in_adminname']; ?></em> [<a href="?action=logout"
                                                                                target="_top">退出</a>]</p>
                ...
                <div class="nav">
                    <ul id="topmenu">
                        <li><em><a href="?iframe=body" id="header_index" hidefocus="true"
                                   onmouseover="previewheader('index')" onmouseout="previewheader()"
                                   onclick="toggleMenu('index', '?iframe=body');doane(event);">首页</a></em></li>
                        <li><em><a href="?iframe=config" id="header_global" hidefocus="true"
                                   onmouseover="previewheader('global')" onmouseout="previewheader()"
                                   onclick="toggleMenu('global', '?iframe=config');doane(event);">全局</a></em></li>
                        <li><em><a href="?iframe=skin" id="header_style" hidefocus="true"
                                   onmouseover="previewheader('style')" onmouseout="previewheader()"
                                   onclick="toggleMenu('style', '?iframe=skin');doane(event);">界面风格</a></em></li>
                        <li><em><a href="?iframe=music" id="header_content" hidefocus="true"
                                   onmouseover="previewheader('content')" onmouseout="previewheader()"
                                   onclick="toggleMenu('content', '?iframe=music');doane(event);">内容审核</a></em></li>
                        <li><em><a href="?iframe=user" id="header_user" hidefocus="true"
                                   onmouseover="previewheader('user')" onmouseout="previewheader()"
                                   onclick="toggleMenu('user', '?iframe=user');doane(event);">用户管理</a></em></li>
                        <li><em><a href="?iframe=backup" id="header_plugin" hidefocus="true"
                                   onmouseover="previewheader('plugin')" onmouseout="previewheader()"
                                   onclick="toggleMenu('plugin', '?iframe=backup');doane(event);">工具</a></em></li>
                    ...
                    <div class="sitemapbtn">
                        <a href="javascript:void(0)" id="cpmap" onclick="showMap();return false;"><img
                                src="static/admincp/css/btn_map.gif" title="管理中心导航(ESC键)" width="46" height="18"/></a>
                    </div>
                </div>
            </div>
        </td>
    ...
    <tr>
        <td valign="top" width="160" class="menutd">
            <div id="leftmenu" class="menu">
                <ul id="menu_index" style="display: none">
                    <li><a href="?iframe=body" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                  title="新窗口打开"></em>管理中心首页</a></li>
                </ul>
                <ul id="menu_global" style="display: none">
                    <li><a href="?iframe=config" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                    title="新窗口打开"></em>站点信息</a></li>
                    <li><a href="?iframe=config&action=cache" hidefocus="true" target="main"><em
                                onclick="menuNewwin(this)" title="新窗口打开"></em>缓存信息</a></li>
                    <li><a href="?iframe=config&action=upload" hidefocus="true" target="main"><em
                                onclick="menuNewwin(this)" title="新窗口打开"></em>上传信息</a></li>
                    <li><a href="?iframe=config&action=pay" hidefocus="true" target="main"><em
                                onclick="menuNewwin(this)" title="新窗口打开"></em>支付信息</a></li>
                    <li><a href="?iframe=config&action=user" hidefocus="true" target="main"><em
                                onclick="menuNewwin(this)" title="新窗口打开"></em>会员信息</a></li>
                </ul>
                <ul id="menu_style" style="display: none">
                    <li><a href="?iframe=skin" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                  title="新窗口打开"></em>模板方案</a></li>
                    <li><a href="?iframe=label" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                   title="新窗口打开"></em>模板标签</a></li>
                </ul>
                <ul id="menu_content" style="display: none">
                    <li class="s">
                        <div class="lsub desc" subid="M11fe1b9c">
                            ...
                            <ol style="display:" id="M11fe1b9c">
                                <li><a href="?iframe=tag" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                             title="新窗口打开"></em>音乐标签</a>
                                </li>
                                <li><a href="?iframe=class" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>音乐栏目</a></li>
                                <li><a href="?iframe=music" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>所有音乐</a></li>
                                <li><a href="?iframe=music&action=add" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>新增音乐</a></li>
                                <li><a href="?iframe=music&action=pass" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>待审音乐</a></li>
                                <li><a href="?iframe=music&action=wrong" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>报错音乐</a></li>
                                <li class="sp"></li>
                            </ol>
                        </div>
                    </li>
                    <li class="s">
                        <div class="lsub desc" subid="M34a79c04">
                            <div onclick="lsub('M34a79c04', this.parentNode)">专辑</div>
                            <ol style="display:" id="M34a79c04">
                                <li><a href="?iframe=special" hidefocus="true" target="main"><em
                                ...
                                <li><a href="?iframe=special&action=class" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>专辑栏目</a></li>
                                <li class="sp"></li>
                            </ol>
                        </div>
                    </li>
                    <li class="s">
                        <div class="lsub desc" subid="M3b496078">
                            <div onclick="lsub('M3b496078', this.parentNode)">歌手</div>
                            <ol style="display:" id="M3b496078">
                                <li><a href="?iframe=singer" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>所有歌手</a></li>
                                <li><a href="?iframe=singer&action=add" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>新增歌手</a></li>
                                <li><a href="?iframe=singer&action=pass" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>待审歌手</a></li>
                                <li><a href="?iframe=singer&action=class" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>歌手栏目</a></li>
                                <li class="sp"></li>
                            </ol>
                        </div>
                    </li>
                    <li class="s">
                        <div class="lsub desc" subid="M9570187e">
                            ...
                            <ol style="display:" id="M9570187e">
                                <li><a href="?iframe=video" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>所有视频</a></li>
                                <li><a href="?iframe=video&action=add" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>新增视频</a></li>
                                <li><a href="?iframe=video&action=pass" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>待审视频</a></li>
                                <li><a href="?iframe=video&action=class" hidefocus="true" target="main"><em
                                            onclick="menuNewwin(this)" title="新窗口打开"></em>视频栏目</a></li>
                                <li class="sp"></li>
                            </ol>
                        </div>
                    </li>
                ...
                <ul id="menu_user" style="display: none">
                    <li><a href="?iframe=user" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                  title="新窗口打开"></em>所有用户</a></li>
                    <li><a href="?iframe=comment" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                     title="新窗口打开"></em>所有评论</a></li>
                    <li><a href="?iframe=feed" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                  title="新窗口打开"></em>所有说说</a></li>
                    <li><a href="?iframe=wall" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                  title="新窗口打开"></em>所有留言</a></li>
                    <li><a href="?iframe=blog" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                  title="新窗口打开"></em>所有日志</a></li>
                    <li><a href="?iframe=photo" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                   title="新窗口打开"></em>所有照片</a></li>
                </ul>
                <ul id="menu_plugin" style="display: none">
                    <li><a href="?iframe=backup" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                    title="新窗口打开"></em>站点备份</a></li>
                    <li><a href="?iframe=sql" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                 title="新窗口打开"></em>执行语句</a></li>
                    <li><a href="?iframe=cache" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                   title="新窗口打开"></em>更新缓存</a></li>
                    <li><a href="?iframe=html" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                  title="新窗口打开"></em>静态生成</a></li>
                    <li><a href="?iframe=update" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                    title="新窗口打开"></em>程序升级</a></li>
                </ul>
                <ul id="menu_system" style="display: none">
                    <li><a href="?iframe=admin" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                   title="新窗口打开"></em>系统用户</a></li>
                    <li><a href="?iframe=link" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                  title="新窗口打开"></em>友情链接</a></li>
                    <li><a href="?iframe=uplog" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                   title="新窗口打开"></em>上传记录</a></li>
                    <li><a href="?iframe=paylog" hidefocus="true" target="main"><em onclick="menuNewwin(this)"
                                                                                    title="新窗口打开"></em>支付记录</a></li>
                </ul>
        ...
        <td valign="top" width="100%" class="mask">
            <iframe src="?iframe=body" id="main" name="main" width="100%" height="100%" frameborder="0" scrolling="yes"
...
<script type="text/javascript">
    ...
    var headers = new Array('index', 'global', 'style', 'content', 'user', 'plugin', 'system', 'app', 'uc'), admincpfilename = '', menukey = '';
