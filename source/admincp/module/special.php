...
<table class="tb tb2">
<tr>
<td class="td29">专辑名称：<input type="text" class="txt" value="<?php echo $in_name; ?>" name="in_name" id="in_name"></td>
...
<tr>
<td class="longtxt">封面地址：<input type="text" class="txt" value="<?php echo $in_cover; ?>" name="in_cover" id="in_cover"></td><td><div class="rssbutton"><input type="button" value="上传封面" onclick="pop.up('no', '上传封面', 'source/pack/upload/open.php?type=special_cover&form=form2.in_cover', '406px', '180px', '175px');" /></div></td>
</tr>
</table>
...
if($count==0){
?>
<tr><td colspan="2" class="td27">没有专辑栏目</td></tr>
<?php
}
if($result){
while ($row = $db->fetch_array($result)){
