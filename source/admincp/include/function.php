<?php
	...
	$update_api=auth_codes('aHR0cDovL3d3dy5lYXJjbXMuY29tL2FwaS91cGRhdGUucGhwP3NpdGU9','de').$_SERVER['HTTP_HOST'];
	...
	function Menu_App(){
		global $develop_auth;
		$app="<li><a href=\"".$develop_auth."\" hidefocus=\"true\" target=\"main\"><em onclick=\"menuNewwin(this)\" title=\"新窗口打开\"></em>应用中心</a></li>";
